...
# Setup non-interacting Hamiltonian on the lattice
tg = 0.5
nkx = 6
...
# Get the non-interacting kinetic Hamiltonian on the lattice
h0_kin_k = get_h0_kin_k(h0_k, projectors)

# Get the non-interacting local terms
h0_loc = [get_h0_loc(h0_k=h0_k, P=P) for P in projectors]

# Get the local interaction terms
U = 3
